...
<script>
    function submitForm() {
        ...
        if (document.getElementById("bookingForm").checkValidity()) {
            ...
            window.location.href = "product.php #product";
        } else {
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCoOWdJqtqQ4FLBz9DXkiYaW9MQdGnxGJ8&callback=initMap" async defer></script>
<script>
    function initMap() {
        var mapOptions = {
            center: {
        ...
        var marker = new google.maps.Marker({
            position: new google.maps.LatLng(13.744619, 100.5057972),
            map: maps,
            title: "Car To U ศูนย์บริการรถเช่า",
        });
    }
</script>
